...
**Senior Fullstack Engineer & Tech Lead** · Based in the south of France 🇫🇷

*10+ years building B2B SaaS products — from architecture to production*

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/robinthiry/)
[![Profile views](https://u8views.com/api/v1/github/profiles/6819007/views/day-week-month-total-count.svg)](https://u8views.com/github/R0binT)
...
const robin = {
  ...
  stack:    ["TypeScript", "React", "Node.js", "NestJS", "GraphQL", "PostgreSQL"],
  clients:  ["TheFork (TripAdvisor)", "Kering", "BPI France"],
  focus:    "Crafting scalable, observable, well-tested B2B products",
  looking:  "New challenges — open to CDI opportunities",
};
```
...
[![Top Languages](https://github-readme-stats-r0bints-projects.vercel.app/api/top-langs/?username=R0binT&theme=dark&hide_border=false&include_all_commits=true&count_private=true&layout=compact)](https://github.com/R0binT)
...
[![Dev Quote](https://quotes-github-readme.vercel.app/api?type=horizontal&theme=radical)](https://github.com/R0binT)
